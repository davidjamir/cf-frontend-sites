/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./worker-configuration.d.ts` (hash: f02d87c626d3391daba3b9806bd4477b)
// Runtime types generated with workerd@1.20260921.1 2026-09-22 nodejs_compat,nodejs_compat_populate_process_env
interface __BaseEnv_CloudflareEnv {
	VINEXT_KV_CACHE: KVNamespace;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	ADAPTER_SECRET_TOKEN: string;
	ADAPTER_API_ENDPOINT: string;
	INTERNAL_SECRET: string;
	APP_ENV: string;
	WORKER_R2_DATABASE: Fetcher /* feed-redirect */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADAPTER_SECRET_TOKEN" | "ADAPTER_API_ENDPOINT" | "INTERNAL_SECRET" | "APP_ENV">> {}
}
